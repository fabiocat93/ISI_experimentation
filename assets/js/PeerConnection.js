...
var controllerToPlayer = {};
controllerToPlayer.readyState = "";
var playerToController = {};
playerToController.readyState = "";
...
(function () {
    ...
    var Offer = {
        createOffer: function (config) {
            ...
            controllerToPlayer = peer.createDataChannel("controllerToPlayer");
            controllerToPlayer.onopen = handleSendChannelStatusChange;
            controllerToPlayer.onclose = handleSendChannelStatusChange;
            //console.log(controllerToPlayer);
    ...
    var Answer = {
        createAnswer: function (config) {
            var peer = new RTCPeerConnection(iceServers);
            playerToController = peer.createDataChannel("playerToController");
            playerToController.onopen = handleSendChannelStatusChange;
            playerToController.onclose = handleSendChannelStatusChange;
            //console.log(controllerToPlayer);
            if (typeof peer.addTrack === 'function') {
                if (config.MediaStream) {
                    config.MediaStream.getTracks().forEach(function (track) {
...
function handleSendChannelStatusChange(event) {
    if (controllerToPlayer) {
        var state_controller = controllerToPlayer.readyState;
        /*
        if (state_controller === "open") {
            console.log("open");
        } else {
    ...
    if (playerToController) {
        var state = playerToController.readyState;
        /*
        if (state === "open") {
            console.log("open");
